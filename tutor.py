...
When a student first arrives, greet them warmly and ask: what are they working on, and what do they already think they know about it?
...
def main():
    print("=" * 50)
    print("   SOCRATIC SCIENCE TUTOR")
    print("   Type 'quit' to exit")
    print("=" * 50)
    print()
    
    # Start the conversation
    opening = chat("Hello, I just started a session.")
    ...
    while True:
        ...
        if user_input.lower() in ['quit', 'exit', 'q']:
            print("\nTutor: Great work today! Keep asking questions — that's how scientists think.")
            break
